...
public class ChatViewModel extends ViewModel {
    ...
    public ChatViewModel(String myUserId, String otherUserId) {
        ...
        referenceMessages.child(myUserId).child(otherUserId).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
    ...
    public void setUserOnline(boolean isOnline){
        referenceUsers.child(myUserId).child("online").setValue(isOnline);
    }
